...
final_column_order_AN = ["mLTimestamp", "eMLTimestamp"] + last_chunk_column_order
final_column_order_PO = ["mLTimestamp_orig", "eMLTimestamp_orig"] + last_chunk_column_order
final_column_order = ["mLTimestamp_orig", "eMLTimestamp_orig"] + last_chunk_column_order
...
def enhance_timestamp_with_apptime(df):
    ...
    """
    # if role == "AN":
    #     timestamps = pd.to_datetime(df["mLTimestamp"], errors="coerce")
    # elif role == "PO": 
    #     timestamps = pd.to_datetime(df["mLTimestamp_orig"], errors="coerce")
    # else:
    ...
    # if role == "AN": 
    #     df["eMLTimestamp"] = enhanced_ts
    # elif role == "PO":
    #     df["eMLTimestamp_orig"] = enhanced_ts
    # return df
    df["eMLTimestamp_orig"] = enhanced_ts
    return df
