...
out_dir <- "/Users/mairahmac/Desktop/myra_code/Python/RewardCollectors_InputGenerate/analyses/results_R/mixedLm_log_A"
...
model_df2List <- c(model_df2_A, model_df2_Ax, model_df2_B, model_df2_Bx, model_df2_C, model_df2_D, model_df2_A)
...
# ------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: log_roundElapsed_s ~ coinLabel + TotSesh_runTot_RoundNum \n\n")

m_3 <- lmer(
  log_roundElapsed_s ~ coinLabel + TotSesh_runTot_RoundNum  + (1 | participantID),
  data = model_df2_A,
  REML = FALSE
)
print(summary(m_3))
...
# -------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: log_roundElapsed_s ~ coinLabel * TotSesh_runTot_RoundNum + recentSwapRate_all \n\n")

m_5 <- lmer(
  log_roundElapsed_s ~ coinLabel + recentSwapRate_all  + (1 | participantID),
  data = model_df2_A,
  REML = FALSE
)
print(summary(m_5))
...
m_6 <- lmer(
  log_roundElapsed_s ~ coinLabel * TotSesh_runTot_RoundNum + recentSwapRate_all  + (1 | participantID),
  data = model_df2_A,
  REML = FALSE
)
print(summary(m_6))
...
# --------------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: log_roundElapsed_s ~ coinLabel + t_early_20 + t_late_20 \n\n")

mL_1 <- lmer(
  log_roundElapsed_s ~ coinLabel + t_early_20 + t_late_20  + (1 | participantID),
  data = model_df2_A,
  REML = FALSE
)
print(summary(mL_1))
...
# -----------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: log_roundElapsed_s ~ coinLabel  * t_early_20 * t_late_20 + recentSwapRate_all \n\n")

mL_3 <- lmer(
  log_roundElapsed_s ~ coinLabel * t_early_20 * t_late_20 + recentSwapRate_all  + (1 | participantID),
  data = model_df2_A,
  REML = FALSE
)
print(summary(mL_3))
