...
out_dir <- "/Users/mairahmac/Desktop/myra_code/Python/RewardCollectors_InputGenerate/analyses/results_R/mixedLm_dropDist"
...
# Inputs / outputs
# ----------------------------
dataFile <- "/Users/mairahmac/Desktop/RC_TestingNotes/FreshStart_redoAgainAgainAgain_PO_redo/EventSegmentation/megaFiles_filtered/roundDur_optionA_output/allIntervalData_AN_baseQC_roundDur_optionA_patched.csv"

out_offending <- "/Users/mairahmac/Desktop/RC_TestingNotes/FreshStart_redoAgainAgain_PO_redo/EventSegmentation/megaFiles_filtered/roundDur_optionA_output/offending_rows_model_ElapsedTime_all_1.csv"
out_used <- "/Users/mairahmac/Desktop/RC_TestingNotes/FreshStart_redoAgainAgain_PO_redo/EventSegmentation/megaFiles_filtered/roundDur_optionA_output/model_ElapsedTime_all_rows_used_1.csv"
...
# ------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: dropDist ~  TotSesh_runTot_RoundNum + coinSet\n\n")
...
# -------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: dropDist ~  TotSesh_runTot_RoundNum + recentSwapRate_all + coinSet\n\n")
...
print(summary(m_7))
run_lmer_diagnostics(m_7, name = "M7_timeVolatility", out_dir = out_dir)
###########################
#   Piece-Wise Learning
###########################
...
mL_4 <- lmer(
  dropDist ~  t_early_20 + t_late_20 + recentSwapRate_all + coinSet +  orderedCollect + coinLabel + (1 | participantID),
  data = analysis_df,
  REML = FALSE
)
print(summary(mL_4))
