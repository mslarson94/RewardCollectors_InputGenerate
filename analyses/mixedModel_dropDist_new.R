...
out_dir <- "/Users/mairahmac/Desktop/myra_code/Python/RewardCollectors_InputGenerate/analyses/results_R/mixedLm_dropDist_new"
...
out_offending <- "/Users/mairahmac/Desktop/RC_TestingNotes/FreshStart_redoAgainAgainAgain_PO_redo/EventSegmentation/megaFiles_filtered/roundDur_optionA_output/offending_rows_model_ElapsedTime_all_1.csv"
out_used <- "/Users/mairahmac/Desktop/RC_TestingNotes/FreshStart_redoAgainAgainAgain_PO_redo/EventSegmentation/megaFiles_filtered/roundDur_optionA_output/model_ElapsedTime_all_rows_used_1.csv"
...
# ----------------------------------
needed <- c(
  "roundElapsed_s", "coinLabel", "TotSesh_runTot_RoundNum", "recentSwapRate_all", "dropDist",
...
# ------------------------------------------------------------------------------------------------
# Mixed model | M2: dropDist  ~ Coin Label + Coin Layout 
# ------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: dropDist ~ coinSet +  coinLabel +  (1 | participantID)\n\n")

m_2 <- lmer(
  dropDist ~ coinSet +  coinLabel +  (1 | participantID),
  data = analysis_df,
  REML = FALSE
)
print(summary(m_2))
...
# ------------------------------------------------------------------------------------------------
# Mixed model | M3: dropDist  ~ Coin Label + Session Time + Coin Layout 
# ------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: dropDist ~  TotSesh_runTot_RoundNum + coinSet +   coinLabel +  (1 | participantID)\n\n")

m_3 <- lmer(
  dropDist ~  TotSesh_runTot_RoundNum + coinSet +   coinLabel +  (1 | participantID),
  data = analysis_df,
  REML = FALSE
)
print(summary(m_3))
...
# ------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: dropDist ~  TotSesh_runTot_RoundNum + coinSet + (1 | participantID)\n\n")

m_4 <- lmer(
  dropDist ~  TotSesh_runTot_RoundNum + coinSet + (1 | participantID),
  data = analysis_df,
  REML = FALSE
)
print(summary(m_4))
...
# -------------------------------------------------------------------------------------------------------------
# Mixed model | M5: dropDist  ~ Coin Label + Volatility + Coin Layout  
# -------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: dropDist ~  recentSwapRate_all + coinSet + coinLabel + (1 | participantID)\n\n")

m_5 <- lmer(
  dropDist ~  recentSwapRate_all + coinSet + coinLabel + (1 | participantID),
  data = analysis_df,
  REML = FALSE
)
print(summary(m_5))
...
# -------------------------------------------------------------------------------------------------------------
# Mixed model | M6: dropDist   ~ Coin Label + SessionTime + Volatility + Coin Layout  
# -------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: dropDist ~  TotSesh_runTot_RoundNum + recentSwapRate_all + coinSet + coinLabel + (1 | participantID)\n\n")

m_6 <- lmer(
  dropDist ~  TotSesh_runTot_RoundNum + recentSwapRate_all + coinSet + coinLabel + (1 | participantID),
  data = analysis_df,
  REML = FALSE
)
print(summary(m_6))
...
# -------------------------------------------------------------------------------------------------------------
# Mixed model | M7: dropDist  ~ Coin Label + SessionTime + Volatility 
# -------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: dropDist ~  TotSesh_runTot_RoundNum + recentSwapRate_all +  coinLabel + (1 | participantID)\n\n")

m_7 <- lmer(
  dropDist ~  TotSesh_runTot_RoundNum + recentSwapRate_all +  coinLabel + (1 | participantID),
  data = analysis_df,
  REML = FALSE
)
print(summary(m_7))
