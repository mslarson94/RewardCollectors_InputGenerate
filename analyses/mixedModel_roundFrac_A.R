...
out_dir <- "/Users/mairahmac/Desktop/myra_code/Python/RewardCollectors_InputGenerate/analyses/results_R/mixedLm_roundFrac_A"
...
# ------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: roundFrac ~ coinLabel + TotSesh_runTot_RoundNum\n\n")

m_3 <- lmer(
  roundFrac ~ coinLabel + TotSesh_runTot_RoundNum + (1 | participantID),
  data = model_df_A,
  REML = FALSE
)
print(summary(m_3))
...
# -------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: roundFrac ~ coinLabel * TotSesh_runTot_RoundNum + recentSwapRate_all\n\n")

m_5 <- lmer(
  roundFrac ~ coinLabel + recentSwapRate_all + (1 | participantID),
  data = model_df_A,
  REML = FALSE
)
print(summary(m_5))
...
m_6 <- lmer(
  roundFrac ~ coinLabel * TotSesh_runTot_RoundNum + recentSwapRate_all + (1 | participantID),
  data = model_df_A,
  REML = FALSE
)
print(summary(m_6))
...
# --------------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: roundFrac ~ coinLabel + t_early_20 + t_late_20\n\n")

mL_1 <- lmer(
  roundFrac ~ coinLabel + t_early_20 + t_late_20 + (1 | participantID),
  data = model_df_A,
  REML = FALSE
)
print(summary(mL_1))
...
# -----------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: roundFrac ~ coinLabel  * t_early_20 * t_late_20 + recentSwapRate_all\n\n")

mL_3 <- lmer(
  roundFrac ~ coinLabel * t_early_20 * t_late_20 + recentSwapRate_all + (1 | participantID),
  data = model_df_A,
  REML = FALSE
)
print(summary(mL_3))
