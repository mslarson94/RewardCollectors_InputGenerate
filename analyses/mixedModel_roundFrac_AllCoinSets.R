# mixedModel_roundFrac_AllCoinSets.R
...
out_dir <- "/Users/mairahmac/Desktop/myra_code/Python/RewardCollectors_InputGenerate/analyses/results_R/mixedLm_roundFrac"
...
# # -------------------------------------------------------------------
# cat("\n\n\n\n\n")
# cat("lmer: roundFrac ~ coinLabel\n\n")
# 
# m_1 <- lmer(
#   roundFrac ~ coinLabel + (1 | participantID),
#   data = model_df,
#   REML = FALSE
# )
# print(summary(m_1))
...
# # ----------------------------------------------------------------------------------
# cat("\n\n\n\n\n")
# cat("lmer: roundFrac ~ coinLabel + coinSet\n\n")
# 
# m_2 <- lmer(
#   roundFrac ~ coinLabel + coinSet + (1 | participantID),
#   data = model_df,
#   REML = FALSE
# )
# print(summary(m_2))
...
# ------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: roundFrac ~ coinLabel + TotSesh_runTot_RoundNum + coinSet\n\n")

m_3 <- lmer(
  roundFrac ~ coinLabel + TotSesh_runTot_RoundNum + coinSet + (1 | participantID),
  data = model_df,
  REML = FALSE
)
print(summary(m_3))
...
# -------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: roundFrac ~ coinLabel * TotSesh_runTot_RoundNum + recentSwapRate_all + coinSet\n\n")

m_5 <- lmer(
  roundFrac ~ coinLabel + recentSwapRate_all + coinSet + (1 | participantID),
  data = model_df,
  REML = FALSE
)
print(summary(m_5))
...
m_6 <- lmer(
  roundFrac ~ coinLabel * TotSesh_runTot_RoundNum + recentSwapRate_all + coinSet + (1 | participantID),
  data = model_df,
  REML = FALSE
)
print(summary(m_6))
...
# --------------------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: roundFrac ~ coinLabel + t_early_20 + t_late_20 + coinSet\n\n")

mL_1 <- lmer(
  roundFrac ~ coinLabel + t_early_20 + t_late_20 + coinSet + (1 | participantID),
  data = model_df,
  REML = FALSE
)
print(summary(mL_1))
...
# -----------------------------------------------------------------------------------------------------------
cat("\n\n\n\n\n")
cat("lmer: roundFrac ~ coinLabel  * t_early_20 * t_late_20 + recentSwapRate_all + coinSet\n\n")

mL_3 <- lmer(
  roundFrac ~ coinLabel * t_early_20 * t_late_20 + recentSwapRate_all + coinSet + (1 | participantID),
  data = model_df,
  REML = FALSE
)
print(summary(mL_3))
