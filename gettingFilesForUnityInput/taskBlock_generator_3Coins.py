...
tutorial_ie_block = '5,'+ tutorial_AN_pos + ',' + tutorial_PO_pos + ',AcollectBwatch'
tutorial_tp1_blocka = '5,' + tutorial_AN_pos + ',' + tutorial_PO_pos + ',ApindropBwatch,'+ str(criterion) + ','
