...
outFile_pre = 'Desktop/task_test/CoinLocations'
...
## Orig Values
normal_vals  = [10.0, 10.0, 2.0, 2.0, 0.0, 0.0]
...
#HV-NV swaps
HV1_NV1_vals = [0.0, 10.0, 2.0, 2.0, 10.0, 0.0]
HV1_NV2_vals = [0.0, 10.0, 2.0, 2.0, 0.0, 10.0]
HV2_NV1_vals = [10.0, 0.0, 2.0, 2.0, 10.0, 0.0]
HV2_NV2_vals = [10.0, 0.0, 2.0, 2.0, 0.0, 10.0]

#LV-NV swaps
LV1_NV1_vals = [10.0, 10.0, 0.0, 2.0, 2.0, 0.0]
LV1_NV2_vals = [10.0, 10.0, 0.0, 2.0, 0.0, 2.0]
LV2_NV1_vals = [10.0, 10.0, 2.0, 0.0, 2.0, 0.0]
LV2_NV2_vals = [10.0, 10.0, 2.0, 0.0, 0.0, 2.0]

#HV-LV swaps
HV1_LV1_vals = [2.0, 10.0, 10.0, 2.0, 0.0, 0.0]
HV1_LV2_vals = [2.0, 10.0, 2.0, 10.0, 0.0, 0.0]
HV2_LV1_vals = [10.0, 2.0, 10.0, 2.0, 0.0, 0.0]
HV2_LV2_vals = [10.0, 2.0, 2.0, 10.0, 0.0, 0.0]
