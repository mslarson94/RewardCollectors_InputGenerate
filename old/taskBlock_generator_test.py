...
tutorial_ie_block = '14,'+ tutorial_AN_pos + ',' + tutorial_PO_pos + ',AcollectBwatch'
tutorial_tp1_blocka = '14,' + tutorial_AN_pos + ',' + tutorial_PO_pos + ',ApindropBwatch,'+ str(criterion) + ','
...
print(large_positions)
large_pos_df_file = outPath + '/large_pos_df.csv'
...
for index, row in big_df.iterrows():
    ...
    # block_text = str(row['set']) + ',' + str(row['strPositions']) + 'ApindropBwatch'# 
    # print(block_text)
    # tp2_block.append(block_text)
