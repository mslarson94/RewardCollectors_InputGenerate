...
def main() -> None:
    ...
    ap.add_argument("--rpi-preproc-dir",required=True,help=("RPi preprocessing directory relative to <base-dir>/<proc-dir>, e.g. RPi_preproc_eMLT_orig."),)
    args = ap.parse_args()
    ...
    for _, row in df.iterrows():
        ...
        if bio_exists or rns_exists:
            cmd_merge_both = ["python", str(merge_both), "--csv_timestamp_column", args.csv_timestamp_column,]
            if bio_exists:
