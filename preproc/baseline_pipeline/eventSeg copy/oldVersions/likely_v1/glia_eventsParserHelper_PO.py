...
def process_true_round_segments(df, allowed_statuses, segmentType):
    events = []
...
def process_special_round_segments(df, allowed_statuses, segmentType):
    """
...
def process_TrueContent(df, allowed_statuses, segmentType):
...
def buildGliaEvents_PO(df, role, allowed_statuses, segmentType):
    return (
        process_TrueContent(df, allowed_statuses, segmentType ) +
        process_marks(df, allowed_statuses, role, segmentType) +
        process_true_round_segments(df, allowed_statuses, segmentType) +
        process_special_round_segments(df, allowed_statuses, segmentType) +
        process_block_segments(df, allowed_statuses, segmentType) +
        process_block_periods_v4(df, allowed_statuses, segmentType)
    )