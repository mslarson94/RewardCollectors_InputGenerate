        ...
        if row["Type"] == "Event" and isinstance(row["Message"], str):
            ...
            if match:
                ...
                try:
                    ...
                    common_info = build_common_event_fields_full(row, i, segmentType)
...
def process_pin_drop_v5a(df, allowed_statuses, segmentType):
    if segmentType == "glia":
        timestamp_col = "mLTimestamp_orig"
        start_time = "start_mLT_orig"
        end_time = "end_mLT_orig"
...
def buildEvents_PO(df, allowed_statuses, segmentType):
    try:
        ...
        cascades = (
            ...
            #process_TrueBlocks(df, allowed_statuses, segmentType) +
            ...
            #process_marks(df, allowed_statuses, role='PO', segmentType=segmentType) +
