...
def parse_args() -> argparse.Namespace:
    ...
    # Verb tuning
    ap.add_argument("--marks-timestamp-col", default="Mono_Time_Adj_verb",
...
def main() -> None:
    ...
    extract = code_dir / "extract_rpi_marks4.py"
        ...
        for label, fname, subdir in rpi_specs:
            ...
            if verb_logs:
                ...
                if verb_full.exists() or args.dry_run:
                    cmd_s = ["python", str(sum), "--in-csv", str(verb_full), "--out-csv", str(verb_short)]
                    attempted += 1
