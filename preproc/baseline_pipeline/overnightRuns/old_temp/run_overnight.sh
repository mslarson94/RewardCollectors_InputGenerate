...
python /Users/mairahmac/Desktop/myra_code/Python/RewardCollectors_InputGenerate/preproc_v2/baseline_pipeline/preprocRaw/preprocRaw_AN.py >> "$LOG_FILE" 2>&1
...
python /Users/mairahmac/Desktop/myra_code/Python/RewardCollectors_InputGenerate/preproc_v2/baseline_pipeline/preprocRaw/preprocRaw_PO.py  >> "$LOG_FILE" 2>&1
