...
CODE_DIR="/Users/mairahmac/Desktop/myra_code/Python/RewardCollectors_InputGenerate/preproc_v2/baseline_pipeline/"
...
python "${CODE_DIR}/alignment/alignPO2AN_part1.py" --dataDir "$DATA_DIR" --metadata "$META_FILE"
