...
# Raw Preprocessing
###################
TEMPPATH="/Users/mairahmac/Desktop/tempVisual"

echo "🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛🐦‍⬛" | tee -a "$LOG_FILE"
echo "🚀 Starting visualMarks.py at $(date)" | tee -a "$LOG_FILE"
python "${CODE_DIR}/alignment/visualMarks.py" \
  --ml_csv "${TEMPPATH}/ObsReward_A_03_17_2025_15_50_events_final.csv" \
  --rns_log "${TEMPPATH}/2025-03-17_15_47_19_616403579.log" \
  --outdir "${TEMPPATH}/out" \
  --annotate_k 5 \
  --biopac_log "${TEMPPATH}/2025-03-17_15_47_24_151094179.log" \
  >> "$LOG_FILE" 2>&1
echo "✅ visualMarks.py  completed at $(date)" | tee -a "$LOG_FILE"
