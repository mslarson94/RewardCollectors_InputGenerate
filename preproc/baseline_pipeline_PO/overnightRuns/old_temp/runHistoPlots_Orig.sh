...
python "${CODE_DIR}/pinDropWrapper.py" \
  --input  "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/CoinSet_DropQual/df_CoinSetID_1_dropQual_good.csv" \
  --out-root "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/OriginalCoins_GoodDrop_Outlier" \
  --formats "pdf" \
  --voi "dropDist" \
...
echo "🚀 Starting pinDropWrapper.py at $(date)" | tee -a "$LOG_FILE"
python "${CODE_DIR}/pinDropWrapper.py" \
  --input  "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/CoinSetID/df_CoinSetID_1.csv" \
  --out-root "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/OriginalCoins_All_Outlier" \
  --formats "pdf" \
  --voi "dropDist" \
  --voi-str "Pin Drop Distance" \
  --voi-unit "(m)" \
...
python "${CODE_DIR}/pinDropWrapper.py" \
  --input  "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/CoinSet_DropQual/df_CoinSetID_1_dropQual_good.csv" \
  --out-root "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/OriginalCoins_GoodDrop_NoOutlier" \
  --formats "pdf" \
  --voi "dropDist" \
  --voi-str "Pin Drop Distance" \
  --voi-unit "(m)" \
...
python "${CODE_DIR}/pinDropWrapper.py" \
  --input  "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/CoinSetID/df_CoinSetID_1.csv" \
  --out-root "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/OriginalCoins_All_NoOutlier" \
  --formats "pdf" \
  --voi "dropDist" \
  --voi-str "Pin Drop Distance" \
  --voi-unit "(m)" \
...
python "${CODE_DIR}/pinDropWrapper.py" \
  ...
  --out-root "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/TP2_Orig_Outlier" \
  --formats "pdf" \
  --voi "dropDist" \
  --voi-str "Pin Drop Distance" \
  --voi-unit "(m)" \
...
python "${CODE_DIR}/pinDropWrapper.py" \
  --input  "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/TPBlock_CoinSetID/BlockNum_Other/df_CoinSetID_1.csv" \
  --out-root "${TRUE_BASE_DIR}/${PROC_DIR}/full/PinDrops_Main/TP2_Orig_NoOutlier" \
  --formats "pdf" \
  --voi "dropDist" \
  --voi-str "Pin Drop Distance" \
  --voi-unit "(m)" \
