    ...
    for i, (start_idx, block_num) in enumerate(block_starts):
        ...
        if prev_coinset_idx is not None:
            ...
            for j in range(prev_coinset_idx, end_idx):
                ...
                # Started collecting. Block:0
                # Started watching other participant's collecting. Block:0
                if isinstance(message, str):
                    if "pindropping" in message.lower() or "pin dropping" in message.lower():
                        print(f"Assigning BlockType 'pindropping' at row {j}")
                        ...
                        print(f"Assigning BlockType 'collection' at row {j}")
...
root_directory = "/Users/mairahmac/Desktop/RC_TestingNotes/SmallSelectedData/RawData"
