...
def mergeLogFiles(metaDataPath, logsDirectory, outputDirectory):
    ...
    #magic_leap_data["cleanedFile"] = magic_leap_data["MagicLeapFiles"].str.replace("_processed", "", regex=False)
    ...
    for log_file in log_files:
        ...
        match = magic_leap_data[magic_leap_data["cleanedFile"] == file_name]
...
def simplifyBlockData(data, output_path):
    ...
    for idx, row in data.iterrows():
        ...
        #     "Observer says it was an OLD round." in message
        #     or "Observer says it was a NEW round." in message
        #     or "Active Navigator says it was an OLD round." in messagedd
        #     or "Active Navigator says it was a NEW round." in message
        # ):
...
logsDirectory = "/Users/mairahmac/Desktop/RC_TestingNotes/SelectedData/ProcessedData/pair_08/02_19_2025/MagicLeaps/"
output_path = "/Users/mairahmac/Desktop/RC_TestingNotes/SelectedData/ProcessedData/pair_08/02_19_2025/MagicLeaps/"
outputDirectory = "/Users/mairahmac/Desktop/RC_TestingNotes/SelectedData/ProcessedData/pair_08/02_19_2025/MagicLeaps/"
...
pt113_day1_df = pd.read_csv("/Users/mairahmac/Desktop/RC_TestingNotes/SelectedData/ProcessedData/pair_08/02_19_2025/MagicLeaps/participant_117B_02_19_2025.csv")
sampleOutPath = "/Users/mairahmac/Desktop/RC_TestingNotes/SelectedData/ProcessedData/pair_08/02_19_2025/MagicLeaps/participant_117B_BlockSummary.csv"
simplifyBlockData(pt113_day1_df, sampleOutPath)