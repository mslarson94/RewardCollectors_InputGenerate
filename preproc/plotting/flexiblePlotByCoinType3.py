...
def make_axes_with_dots(
    *,
    ...
    """Create (fig, ax_main, ax_dots) where ax_dots is a short strip sharing x with ax_main. If dot_mode != 'panel', returns (fig, ax_main, None)."""
    if dot_mode == "panel":
...
def plot_hist_kde_by_coin(
    ...
    *,
    ...
    # If your label still feels cramped, nudge it a bit:
